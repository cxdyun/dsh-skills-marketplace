...
var WRITE_HEADERS = { "content-type": "application/json", "x-dsh-skills-marketplace": "1" };
...
var styles = {
  ...
  capiChevron: { display: "inline-flex", alignItems: "center", justifyContent: "center", flex: "0 0 28px", width: 28, height: 28, padding: 0, margin: "0 0 0 6px", border: 0, borderRadius: 6, background: "transparent", color: T.l3, cursor: "pointer", appearance: "none" },
  ...
  actionButton: { flexShrink: 0, minWidth: 0, padding: "0 6px", whiteSpace: "nowrap" },
  // 高敏感操作(移除来源):红色文字、无边框,与常规操作区分
  dangerButton: { flexShrink: 0, minWidth: 0, padding: "0 6px", whiteSpace: "nowrap", color: T.error },
  ...
  loadingSpinner: { display: "inline-flex", flex: "0 0 16px", width: 16, height: 16, boxSizing: "border-box", border: "2px solid currentColor", borderRightColor: "transparent", borderRadius: "50%", animation: "dsh-skills-spin 0.8s linear infinite", transformOrigin: "50% 50%" },
  // 插件网格卡
  ...
  notice: { color: T.success, fontSize: 12, margin: "8px 0", whiteSpace: "pre-wrap" },
  // 移除二次确认弹窗:遮罩 + 居中卡片,确认按钮为红色
  modalMask: { position: "fixed", inset: 0, background: "rgba(0,0,0,.45)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1e3, padding: 20 },
  modalCard: { background: T.bg1, border: `1px solid ${T.borderSoft}`, borderRadius: 12, boxShadow: "0 12px 40px rgba(0,0,0,.28)", maxWidth: 380, width: "100%", padding: "18px 18px 14px", display: "flex", flexDirection: "column", gap: 10, boxSizing: "border-box" },
  modalTitle: { fontSize: 15, fontWeight: 600, lineHeight: "22px", color: T.l1, margin: 0 },
  modalName: { fontSize: 12, color: T.l3, fontFamily: "ui-monospace,Menlo,monospace", margin: 0, overflowWrap: "anywhere" },
  modalBody: { fontSize: 13, lineHeight: "20px", color: T.l2, margin: 0 },
...
function SkillMarketSection(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.root, children: [
    ...
    notice && !error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.notice, children: notice }),
      ...
      adding && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.addCard, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.formActions, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Button, { variant: "outline", size: "sm", style: styles.configAction, onClick: addSource, disabled: busy, children: busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.loadingLabel, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.loadingSpinner }),
            "\u4FDD\u5B58"
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.capiTrailing, onClick: (e) => e.stopPropagation(), children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        import_dsh_client_ui_primitives.Button,
                        {
                          ...
                          children: updating === s.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.loadingLabel, children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.loadingSpinner }),
                            t("updating")
                          ] }) : t("update")
                        }
                      ),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Button, { variant: "ghost", size: "sm", style: styles.actionButton, disabled: updating === s.id, onClick: () => editSource(s), children: t("edit") }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Button, { variant: "ghost", size: "sm", style: styles.dangerButton, disabled: removing === s.id || updating === s.id, onClick: () => {
                        setError("");
                        setConfirming(s);
                      }, children: removing === s.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.loadingLabel, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.loadingSpinner }),
                        t("removeSource")
                      ] }) : t("removeSource") }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        "button",
                        {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { "aria-hidden": "true", style: { ...styles.capiChevronIcon, ...open ? styles.capiChevronOpen : null }, children: "\u2304" })
                        }
                      )
                    ] })
                  ]
    ...
    confirming && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        onClick: () => {
          if (removing !== confirming.id) setConfirming(null);
        },
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: styles.modalTitle, children: t("confirmRemoveTitle") }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: styles.modalName, children: [
                sourceName(confirming),
                " \xB7 ",
                confirming.url
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: styles.modalBody, children: t("confirmRemoveBody") }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.modalActions, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Button, { variant: "ghost", size: "sm", style: styles.actionButton, disabled: removing === confirming.id, onClick: () => setConfirming(null), children: t("cancel") }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_dsh_client_ui_primitives.Button,
                  {
                    variant: "ghost",
                    ...
                    children: removing === confirming.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.loadingLabel, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.loadingSpinner }),
                      t("confirmRemoveBtn")
                    ] }) : t("confirmRemoveBtn")
                  }
